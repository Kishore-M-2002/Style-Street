...
const Profile = () => {
  ...
  const getUserData = async () => {
    try {
      const response = await axios(`https://backend-street.onrender.com/user/${id}`);
  ...
  const updateProfile = async (e) => {
    ...
    try{
      ...
      const getResponse = await axios(`https://backend-street.onrender.com/user/${id}`);
      const userObj = getResponse.data;

      // saljemo get(default) request
      const putResponse = await axios.put(`https://backend-street.onrender.com/user/${id}`, {
        id: id,
